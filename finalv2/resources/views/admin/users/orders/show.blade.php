...
@section('main')
    <div class="container container-padding">
        ...
        @endif
        <div class="d-flex">
            @if($backurl =='admin.users.index')
                <a href="{{route('admin.users.index')}}" class="btn btn-secondary mx-1 my-1 w-100">VOLVER</a>
            @else
                <a href="{{route('admin.users.show', ['id'=> $user->id])}}" class="btn btn-secondary mx-1 my-1 w-100">VOLVER</a>
            @endif
        </div>
