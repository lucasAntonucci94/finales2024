...
@endif
<h2 class="w-100 text-center my-5">Editar Usuario: {{$user->name}}</h2>
@if($errors->any())
...
<div class="container w-100 text-center ">
    <form class="row mx-auto" action="{{route('users.edit',['id'=> $user->id])}}" method="post"  enctype="multipart/form-data">
        @csrf
