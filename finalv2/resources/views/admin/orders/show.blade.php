...
@section('title','Pantalla Ver Pedido: '.$order->id)
...
@endif
<h2 class="w-100 text-center my-5 textBreak">Vista del pedido ID: {{$order->id}} </h2>
...
<a href="{{url('admin/orders')}}" class="btn btn-secondary my-1 w-100">VOLVER</a>
