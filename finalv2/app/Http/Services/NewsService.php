...
class NewsService
{
    ...
    public function editNew(Request $request, int $id){
        ...
        try{
            ...
            return $this->toRoute('create.form.new',[
                'error' => 'El newo no se pudo crear por un error en la base de datos.'
            ])->withInput();
        }

         return $this->toRoute('admin.news.index')->with('message.success','El newo <b>'.e($new->detail).'</b> fue editado exitosamente.');
    }
    ...
    public function delete(int $id){
        ...
        try{
            ...
            return $this->toRoute('news.index',[
                'error' => 'El newo no se pudo eliminar por un error en la base de datos.'
            ])->withInput();
        }

        return $this->toRoute('admin.news.index')->with('message.success','El newo <b>'.e($new->detail).'</b> fue eliminado exitosamente.');    }
