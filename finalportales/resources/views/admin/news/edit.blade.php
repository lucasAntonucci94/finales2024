...
<div class="container-fluid">
    <div class="row py-4 bg-light">
        <div class="col-12 text-center">
            <h1>Edita el producto: {{ $new->title }}</h1>
        </div>
        <div class="col-12">
    ...
    <div class="container w-100  pb-5">
        <form class="row mx-auto border mt-3 mb-5 p-5" action="{{route('news.edit',['id'=> $new->id_new])}}" method="post"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-6">
                <div class="row d-flex">
                    <div class="col-12 d-none">
                        ...
                        <input  type="text" name="id_user" id="id_user" class="form-control w-100"
                        value="{{old('id_user', auth()->user()->id)}}"
                    >
                    </div>
                    <div class="col-12">
                        <label for="title"  class="form-label my-3">Nombre</label>
                        <input type="text" name="title" id="title" placeholder="Ingrese un nombre" class="form-control w-100 @error('title') is-invalid @enderror"
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="detail" id="detail" placeholder="Ingrese un detalle"  class="form-control w-100 @error('detail') is-invalid @enderror"
