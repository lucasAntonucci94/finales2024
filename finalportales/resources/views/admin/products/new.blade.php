...
<div class="container-fluid">
    ...
    <div class="container w-100  pb-5">
        <form class="row mx-auto border mt-3 mb-5 p-5" action="{{route('products.create')}}" method="post"  enctype="multipart/form-data">
            @csrf
            <div class="col-6">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12 ">
                        ...
                        <select name="id_country" id="id_country" style="margin: auto;" class="form-control w-100">
                            ...
                            @selected($country->id_country == old('id_country'))
                            >{{$country->name}}</option>
                            @endforeach
                        </select>
                        @error('id_country')
                    ...
                    <div class="col-12 ">
                        ...
                        <select name="id_provider" id="id_provider" style=" margin: auto;" class="form-control  w-100">
                            ...
                            @selected($provider->id_provider == old('id_provider'))
                    ...
                    <div class="col-12">
                        ...
                        <input  type="date" name="date" id="date" placeholder="Seleccione una fecha" class="form-control w-100 @error('date') is-invalid @enderror"
                    ...
                    <div class="col-12">
                        ...
                        <textarea type="text" name="description" id="description" placeholder="Ingrese una descripción"  style="min-height:250px;" class="form-control w-100 @error('description') is-invalid @enderror"
