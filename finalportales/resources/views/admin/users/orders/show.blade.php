...
@section('title','Pedidos abm del Usuario')
...
<div class="container mt-4">
    <div class="row  w-100">
        <div class="col-11">
            <a class="btn btn-dark my-3 text-white" href="<?= url('admin/users');?>">Volver</a>
        </div>
    </div>
    @if($orders != null)
    ...
    @else
        <div class="row">
            <div class="col-12 text-center">
                <p class="lead">No se realizaron compras para este usuario.</p>
            </div>
        </div>
    @endif
</div>
