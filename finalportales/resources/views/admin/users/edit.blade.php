...
<div class="container w-100  pb-5">
    <form class="row mx-auto border mt-3 mb-5 p-5" action="{{route('users.edit',['id'=> $user->id])}}" method="post"  enctype="multipart/form-data">
        @csrf
            ...
            <div class="row d-flex">
                ...
                <div class="col-12">
                    <div class="form-group w-100 my-2">
                        ...
                        <select name="id_role" id="id_role" class="form-control my-2 w-100 custom-select">
